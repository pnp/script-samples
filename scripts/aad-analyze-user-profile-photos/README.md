...
This script uses Azure Cognitive Service API and Microsoft 365 CLI to analyze user profile pictures and assess whether they meet the standards placed by the organization. It can be customized to ban content within an org channel or collaboration network where employees post pictures, memes, etc.
 ...
 - Microsoft 365 users
 - [Computer Vision API instance and API key](https://azure.microsoft.com/services/cognitive-services/computer-vision/)
...
Sample first appeared on [Analyze User Profile Photos using Azure Computer Vision API | CLI for Microsoft 365](https://pnp.github.io/cli-microsoft365/sample-scripts/aad/analyze-user-profile-photos/)
