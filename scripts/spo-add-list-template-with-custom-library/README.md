...
<img src="https://m365-visitor-stats.azurewebsites.net/script-samples/scripts/spo-add-list-template-with-custom-library?labelText=Visitors" class="img-visitor" aria-hidden="true" />
